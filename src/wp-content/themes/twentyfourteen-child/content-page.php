	...
	<div class="entry-content">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-2 col-md-2 col-sm-2 col-xs-10"><?php echo render_download_link( $chapter->ID ); ?><?php echo render_external_link( $chapter->ID ); ?></div>
			</div>
	...
	<div class="entry-content">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-2 col-md-2 col-sm-2 col-xs-10"><?php echo render_details_link( $paragraph->ID ); ?></div>
			</div>
